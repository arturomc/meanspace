# [![MEAN Logo](http://www.mean.io/img/logos/meanlogo.png)](http://mean.io/) ___
# meanspace
...
meanspace is a boilerplate social media implmentation, build over the mean.io stack, and free to use
